...
namespace DicomApp.BL.Services
{
    public class Common_UserDeviceService : BaseService
    {
        ...
        public static Common_UserDeviceResponse ListCommon_UserDevice(Common_UserDeviceRequest request)
        {
            ...
            RunBase(request, res, (Common_UserDeviceRequest req) =>
            {
                try
                {
                    var query = request.context.CommonUserDevice.Select(p => new Common_UserDeviceDTO
                    {
        ...
        public static Common_UserDeviceResponse DeleteCommon_UserDevice(Common_UserDeviceRequest request)
        {
            ...
            RunBase(request, res, (Common_UserDeviceRequest req) =>
            {
                try
                {
                    ...
                    var Common_UserDevice = request.context.CommonUserDevice.FirstOrDefault(c => c.Id == model.ID);
        ...
        public static Common_UserDeviceResponse AddCommon_UserDevice(Common_UserDeviceRequest request)
        {
            ...
            RunBase(request, res, (Common_UserDeviceRequest req) =>
            {
                try
                {
                    var Common_UserDevice = AddOrEditCommon_UserDevice(request.Common_UserDeviceRecord);
        ...
        public static Common_UserDeviceResponse EditCommon_UserDevice(Common_UserDeviceRequest request)
        {
            ...
            RunBase(request, res, (Common_UserDeviceRequest req) =>
            {
                try
                {
                    ...
                    {
                        //update whole Agency
                        Common_UserDevice = AddOrEditCommon_UserDevice(request.Common_UserDeviceRecord, Common_UserDevice);
                        request.context.SaveChanges();
        ...
        private static CommonUserDevice AddOrEditCommon_UserDevice(Common_UserDeviceDTO common_UserDeviceRecord, CommonUserDevice common_UserDevice = null)
        {
            if (common_UserDevice == null)
            {
        ...
        private static IQueryable<Common_UserDeviceDTO> ApplyFilter(IQueryable<Common_UserDeviceDTO> query, Common_UserDeviceDTO record)
        {
            ...
            {
                query = query.Where(p => p.DeviceIMEI != null && p.DeviceIMEI.Contains(record.DeviceIMEI));
            }
