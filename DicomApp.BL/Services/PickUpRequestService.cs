                    ...
                    try
                    {
                        ...
                        else // Save delivery pickup shipments
                        {
                            ...
                            foreach (var item in request.PickupDTO.PickupItems)
                            {
                                ...
                                request
                                    .context.Shipment.FirstOrDefault(s =>
                                        s.ShipmentId == item.ShipmentId
                                    )
                                    .PickupRequestId = newPickupRequest.PickupRequestId;
                            }
                        }
                        ...
                        {
                            var ships = request.context.Shipment.Where(s =>
            ...
            RunBase(
                ...
                (PickUpRequestRequest req) =>
                {
                    try
                    {
                        ...
                        var shipments = request.context.Shipment.Where(s =>
                            s.PickupRequestId == pickup.PickupRequestId
                        );
        ...
        public static PickUpRequestResponse AssignPickupRequests(PickUpRequestRequest request)
        {
            ...
            RunBase(
                ...
                (PickUpRequestRequest req) =>
                {
                    try
                    {
                        var pickupRequests = request.context.PickupRequest.Where(r =>
                        ...
                        foreach (var pickup in pickupRequests)
                        {
                            ...
                            foreach (var ship in shipments)
                            {
                                ...
                                var follow = new FollowUpDTO
                                {
                                    ...
                                    Title = request
                                        .context.Status.FirstOrDefault(s =>
                                            s.Id == (int)EnumStatus.Assigned_For_Pickup
                                        )
                                        .NameEN,
                                    Comment = request
                                        .context.CommonUser.FirstOrDefault(u =>
                                            u.Id == request.PickupDTO.DeliveryManId
                                        )
                                        .Name,
                                    CreatedBy = request.UserID,
                                    ShipmentId = ship.ShipmentId,
                            ...
                            foreach (var pickupItem in pickupItems)
                            {
                                ...
                                if (pickupItem.ShipmentId.HasValue) // Shipment
                                {
                                    var ship = request.context.Shipment.FirstOrDefault(r =>
                                        r.ShipmentId == pickupItem.ShipmentId
                                    );
                    ...
                    try
                    {
                        var query = request
                            ...
                            .Select(p => new PickupItemDTO
                            {
                                ...
                                PickupRequestId = p.PickupRequestId,
                                VendorProductName = p.ShipmentId.HasValue
                                    ? p.Shipment.RefId
