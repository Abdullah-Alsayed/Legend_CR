...
namespace DicomApp.BL.Services
{
    public class UserhubconnectionService : BaseService
    {
        ...
        public static UserhubconnectionResponse ListUserhubconnection(UserhubconnectionRequest request)
        {
            var res = new UserhubconnectionResponse();
            RunBase(request, res, (UserhubconnectionRequest req) =>
            {
                try
                {
                    var query = request.context.Userhubconnection.Select(p => new UserhubconnectionDTO
                    {
        ...
        public static UserhubconnectionResponse DeleteUserhubconnection(UserhubconnectionRequest request)
        {
            ...
            RunBase(request, res, (UserhubconnectionRequest req) =>
            {
                try
                {
                    ...
                    var Userhubconnection = request.context.Userhubconnection.FirstOrDefault(c => c.Id == model.ID);
        ...
        public static UserhubconnectionResponse AddUserhubconnection(UserhubconnectionRequest request)
        {
            ...
            RunBase(request, res, (UserhubconnectionRequest req) =>
            {
                try
                {
                    var Userhubconnection = AddOrEditUserhubconnection(request.UserhubconnectionRecord);
        ...
        public static UserhubconnectionResponse EditUserhubconnection(UserhubconnectionRequest request)
        {
            ...
            RunBase(request, res, (UserhubconnectionRequest req) =>
            {
                try
                {
                    ...
                    {
                        //update whole Agency
                        Userhubconnection = AddOrEditUserhubconnection(request.UserhubconnectionRecord, Userhubconnection);
                        request.context.SaveChanges();
        ...
        private static Userhubconnection AddOrEditUserhubconnection(UserhubconnectionDTO userhubconnectionRecord, Userhubconnection userhubconnection = null)
        {
            if (userhubconnection == null)
            {
        ...
        private static IQueryable<UserhubconnectionDTO> ApplyFilter(IQueryable<UserhubconnectionDTO> query, UserhubconnectionDTO record)
        {
