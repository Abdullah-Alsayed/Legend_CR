...
namespace DicomApp.BL.Services
{
    public class VendorProductService : BaseService
    {
        ...
        public static VendorProductResponse GetLastProduct(VendorProductRequest request)
        {
            ...
            RunBase(
                ...
                (VendorProductRequest ProductRequest) =>
                {
                    ...
                    {
                        var query = request
                            .context.VendorProduct.Select(c => new VendorProductDTO
                            {
                                VendorProductId = c.VendorProductId,
                                OriginalPrice = c.OriginalPrice,
                                Description = c.Description,
        ...
        public static VendorProductResponse GetProductById(VendorProductRequest request)
        {
            ...
            RunBase(
                ...
                (VendorProductRequest ProductRequest) =>
                {
                    ...
                    {
                        var query = request
                            .context.VendorProduct.Where(i =>
                                i.VendorProductId == request.VendorProductDTO.VendorProductId
                            )
        ...
        public static VendorProductResponse EditProduct(VendorProductRequest request)
        {
            ...
            RunBase(
                ...
                (VendorProductRequest ProductRequest) =>
                {
                    try
                    {
                        var VendorProduct = request.context.VendorProduct.Find(
                            ProductRequest.VendorProductDTO.VendorProductId
                        );
        ...
        public static VendorProductResponse DeleteProduct(VendorProductRequest Request)
        {
            ...
            RunBase(
                ...
                (VendorProductRequest ProductRequest) =>
                {
                    try
                    {
                        var VendorProduct = Request.context.VendorProduct.FirstOrDefault(vp =>
                            vp.VendorProductId == Request.VendorProductDTO.VendorProductId
                        );
        ...
        private static IQueryable<VendorProductDTO> ApplyFilter(
            IQueryable<VendorProductDTO> query,
        ...
        )
        {
            ...
            {
                query = query.Where(c =>
                    (!string.IsNullOrEmpty(c.Name) && c.Name.Contains(filter.Search))
