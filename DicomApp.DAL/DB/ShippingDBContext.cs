...
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AccountTransaction>(entity =>
            {
                ...
                entity.HasOne(d => d.CashTransfer)
                ...
                entity.HasOne(d => d.PickupRequest)
                    .WithMany(p => p.AccountTransaction)
            ...
            modelBuilder.Entity<CommonResource>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.ResourceKey, e.ResourceLang })
            ...
            modelBuilder.Entity<CommonUserDevice>(entity =>
            {
                ...
                entity.Property(e => e.AuthCreationDate)
                    .HasColumnType("datetime")
                    .HasDefaultValueSql("(getdate())");

                entity.Property(e => e.AuthExpirationDate)
                    .HasColumnType("datetime")
                    .HasDefaultValueSql("(getdate())");
            ...
            modelBuilder.Entity<Notification>(entity =>
            {
                ...
                entity.HasOne(d => d.RecipientRole)
            ...
            modelBuilder.Entity<PickupRequest>(entity =>
            {
                ...
                entity.HasOne(d => d.PickupRequestType)
                    .WithMany(p => p.PickupRequest)
            ...
            {
                entity.HasIndex(e => new { e.AppServiceId, e.RoleId })
            ...
            modelBuilder.Entity<Shipment>(entity =>
            {
                ...
                entity.HasOne(d => d.ShipmentService)
                    .WithMany(p => p.Shipment)
                ...
                entity.HasOne(d => d.WarehousePacking)
            ...
            modelBuilder.Entity<ShipmentCustomerFollowUp>(entity =>
            {
                ...
                entity.Property(e => e.NextCallTimeTo)
                    .HasColumnType("datetime")
                    .HasDefaultValueSql("(getdate())");
