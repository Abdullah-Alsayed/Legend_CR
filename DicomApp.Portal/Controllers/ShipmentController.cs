...
namespace DicomApp.Portal.Controllers
{
    public class ShipmentController : Controller
    {
        ...
        public ShipmentController(ShippingDBContext context)
        {
            _context = context;
        }
        ...
        public ActionResult TrackShipment(string TrackShipment)
        {
            ...
            var response = DicomApp.BL.Services.ShipmentService.GetShipment(request);
        ...
        public IActionResult Refund(string s)
        {
            ...
            var shipResponse = DicomApp.BL.Services.ShipmentService.GetShipment(shipRequest);
        ...
        )
        {
            ...
            var response = DicomApp.BL.Services.ShipmentService.Cancel(request);
        ...
        public IActionResult ReturnToVendor(int shipID)
        {
            ...
            var response = DicomApp.BL.Services.ShipmentService.ChangeStatus(request);
