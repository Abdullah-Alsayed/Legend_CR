...
//            if (currRoleID == EnumRole.SuperAdmin.ToString())
//                ViewData.Lookup.RoleDTOs = ViewData
//                    .Lookup.RoleDTOs.Where(r => r.Id != EnumRole.Vendor.ToString())
//                    .ToList();
//            else if (currRoleID == EnumRole.Admin.ToString())
//                ViewData.Lookup.RoleDTOs = ViewData
//                    .Lookup.RoleDTOs.Where(r =>
//                        r.Id != EnumRole.SuperAdmin && r.Id != EnumRole.Vendor.ToString()
//                    )
//                    .ToList();
//            else
//                ViewData.Lookup.RoleDTOs = ViewData
//                    .Lookup.RoleDTOs.Where(r =>
//                        r.Id != EnumRole.SuperAdmin.ToString()
//                        && r.Id != EnumRole.Admin.ToString()
//                        && r.Id != EnumRole.Vendor.ToString()
//                    )
//                    .ToList();
...
//                UserDTO = new UserDTO()
//                {
//                    RoleID = EnumRole.Vendor.ToString(),
//                    Search = Search,
//                    Id = VendorID
//                },
//                PageIndex = PageIndex,
